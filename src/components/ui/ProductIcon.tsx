...
export function ProductIcon({ slug, size = 24, className = "" }: ProductIconProps) {
  ...
  return (
    <svg style={{ width: size, height: size }} className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      {slug === "modal4ward" && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M6 3v12m0 0a3 3 0 103 3M6 15a3 3 0 01-3 3m9-15a3 3 0 013 3v6a3 3 0 01-3 3M18 6a3 3 0 00-3-3" />}
